...
<body>
	<div class="container">
		...
		<form action="EditPalabra" method="POST">
			<div class="mb-3">
				<label for="id" class="form-label">ID</label> 
				<input type="number" class="form-control" id="id" name="id" placeholder="101" readonly="readonly" value="${p.getId()}">
			</div>
			<div class="mb-3">
				<label for="nombre" class="form-label">Palabra</label> 
				<input type="text" class="form-control" id="nombre" name="nombre" placeholder="chipamogli" value="${p.getNombre()}">
			</div>
			<div class="mb-3">
